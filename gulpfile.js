...
gulp.task('watch', function() {
  ...
  gulp.watch(['build/*.html', 'build/assets/css/*.css', 'build/assets/js/*.js', 'build/assets/js/vendors/*.js', 'build/assets/img/*', 'build/assets/json/*']).on('change', browserSync.reload);
});
...
gulp.task('default', ['images', 'sass', 'scripts', 'vendors-sass', 'vendors-css', 'html', 'favicon',  'webfonts', 'fonts', 'vendors', 'gif', 'watch' , 'json'], function() {});
